...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
	    ...
	    // 32.9 (latitude) and -117.2 (longitude) La Jolla's locaiton
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
		
		// This line makes the map interactive
		MapUtils.createDefaultEventDispatcher(this, map1);
		
		// Adding Second Map on the right pointing to a different location
		map2 = new UnfoldingMap(this, 425, 50, 350, 500, provider);
	    map2.zoomAndPanTo(zoomLevel, new Location(11.03f, 76.94f)); // Coimbatore
        //map2.zoomAndPanTo(zoomLevel, new Location(-22.9f, -43.2f)); // Rio de Janeiro, Brazil
        //map2.zoomAndPanTo(zoomLevel, new Location(-12.0f, -77.0f));    // Peru    
