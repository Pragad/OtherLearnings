...
public class BasicDocument extends Document 
{
	 ...
	 * ignores numbers when you count words
	 * 
	 * ASSUMPTION: The document does not have any strings that combine numbers and letters. 
	 * 
	...
	{
		List<String> sentTokens = getTokens("[^.!?]+");
	    return sentTokens.size();
	}
	
	/**
	 * Get the total number of syllables in the document (the stored text). 
	 * To count the number of syllables in a word, it uses the following rules:
	 *    1. Each contiguous sequence of one or more vowels is a syllable, 
	...
	{
		// Extract just the word with characters
		List<String> wordTokens = getTokens("[a-zA-Z]+");
		int numSyllables = 0;
	...
	public static void main(String[] args)
	{
		 ...
		 */
		System.out.println("TESTING BASIC EDITOR");
